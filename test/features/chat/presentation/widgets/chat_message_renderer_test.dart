...
void main() {
  ...
  group('ChatMessageRenderer - text responses', () {
    testWidgets('renders for text responseType without throwing', (
      tester,
    ) async {
    ...
    testWidgets('null component falls through to text rendering', (
      tester,
    ) async {
      ...
      await tester.pumpWidget(
        await _wrap(ChatMessageRenderer(response: response)),
      );
      await tester.pump();
      expect(tester.takeException(), isNull);
    });
  ...
  group('ChatMessageRenderer - component rendering', () {
    ...
    testWidgets('renders learningStart component with first lesson', (
      tester,
    ) async {
    ...
    testWidgets('renders lessonCard with null lessonId as invalid', (
      tester,
    ) async {
      final response = _componentResponse('lessonCard', {});
      await tester.pumpWidget(
    ...
    testWidgets('unknown component type falls back to markdown', (
      tester,
    ) async {
    ...
    testWidgets('renders text + component when text is non-empty', (
      tester,
    ) async {
      final response = _componentResponse('dua', {
        'arabic': 'ربي',
